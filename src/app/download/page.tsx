          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <div className="space-y-4">
                <a
                  href="https://github.com/GodkuProject/GodkuWebsite/releases/download/6.23.0/Godku_Project_Classic_6.23.0_Alpha6.apk "
                  target="_blank"
                ...
                <a
                  href="https://github.com/GodkuProject/GodkuWebsite/releases/download/6.23.0/Godku_Project_Clone_6.23.0_Alpha6.apk"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="glass-card hover:border-dbz-orange/50 p-5 flex items-center justify-between transition-all duration-300 hover:-translate-y-1"
                >
            ...
            >
              <div className="space-y-4">
                <a
                  href="https://github.com/GodkuProject/GodkuWebsite/releases/download/6.23.0/Godku_Project_Base_6.23.0.ipa"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://github.com/GodkuProject/GodkuWebsite/releases/download/6.23.0/Godku_Project_Injection_6.23.0.ipa"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="glass-card hover:border-dbz-blue/50 p-5 flex items-center justify-between transition-all duration-300 hover:-translate-y-1"
                >
                ...
                <a
                  href="https://github.com/GodkuProject/GodkuWebsite/releases/download/6.23.0/Godku_Project_Instant_Win_6.23.0.ipa"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="glass-card hover:border-dbz-blue/50 p-5 flex items-center justify-between transition-all duration-300 hover:-translate-y-1"
                >
